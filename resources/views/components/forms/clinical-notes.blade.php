<div class="editor-container">
  <div class="editor-shell">
    <div class="toolbar" id="toolbar">
      ...
      <button type="button" class="toolbar-btn" id="uploadClinicalImage" title="Insert image" aria-label="Insert image">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect width="18" height="18" x="3" y="3" rx="2" />
      ...
      <input id="clinicalImageInput" type="file" accept="image/jpeg,image/png,image/gif,image/webp" hidden>
      <select id="clinicalImageWidth" class="image-width-select" title="Image width" aria-label="Image width" disabled>
