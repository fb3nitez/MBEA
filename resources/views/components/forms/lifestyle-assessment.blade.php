...
@php
    ...
    $substances = [
        ['id' => 'subNicotine', 'label' => 'Nicotine (cigarettes, vaping)', 'amountId' => 'subNicotineAmount', 'amountLabel' => 'Amount per day', 'amountPlaceholder' => 'Enter amount', 'concernId' => 'subNicotineConcern'],
        ['id' => 'subAlcohol', 'label' => 'Alcohol', 'amountId' => 'subAlcoholAmount', 'amountLabel' => 'Drinks per week', 'amountPlaceholder' => 'Enter amount', 'concernId' => 'subAlcoholConcern'],
        ['id' => 'subRecreational', 'label' => 'Recreational Drugs', 'amountId' => 'subRecreationalAmount', 'amountLabel' => 'Frequency', 'amountPlaceholder' => 'Enter frequency', 'concernId' => 'subRecreationalConcern'],
        ['id' => 'subMarijuana', 'label' => 'Marijuana', 'amountId' => 'subMarijuanaAmount', 'amountLabel' => 'Frequency', 'amountPlaceholder' => 'Enter frequency', 'concernId' => 'subMarijuanaConcern'],
        ['id' => 'subScreentime', 'label' => 'Social Media / Screen Time', 'amountId' => 'subScreentimeAmount', 'amountLabel' => 'Hours per day', 'amountPlaceholder' => 'Enter hours', 'concernId' => 'subScreentimeConcern'],
        ['id' => 'subGambling', 'label' => 'Gambling', 'amountId' => 'subGamblingAmount', 'amountLabel' => 'Frequency', 'amountPlaceholder' => 'Enter frequency', 'concernId' => 'subGamblingConcern'],
        ['id' => 'subOthers', 'label' => 'Others', 'amountId' => 'subOthersSpecify', 'amountLabel' => 'Please specify', 'amountPlaceholder' => 'Please specify', 'concernId' => 'subOthersConcern'],
    ];
@endphp
...
<div class="space-y-6">
    <div class="card bg-base-200/50 border border-base-content/10">
        <div class="card-body gap-4">
            ...
            <input type="range" name="healthScore" id="health-score" min="0" max="10" step="1" value="5" class="range range-sm w-full" />
            ...
            <div class="card-body gap-4">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="form-control">
                        ...
                        <input type="number" name="sleepHours" id="sleep-hours" placeholder="e.g., 7" class="input input-bordered w-full" />
                    </div>
                    <div class="form-control">
                        <label class="label" for="tired-frequency">
                            <span class="label-text">How often do you feel tired?</span>
                        </label>
                        <select name="tiredFrequency" id="tired-frequency" class="select select-bordered w-full">
            ...
            <div class="card-body gap-4">
                ...
                <div class="grid gap-4">
                    <div class="form-control">
                        ...
                        <select name="weightPerception" id="weight-perception" class="select select-bordered w-full">
                    ...
                    <div class="form-control">
                        ...
                        <select name="fastFood" id="fast-food" class="select select-bordered w-full">
                            <option value="">Select frequency</option>
                            <option value="Never">Never</option>
                            <option value="Monthly">1-2 times per month</option>
                ...
                <div class="form-control">
                    ...
                    <select name="fruitsVeg" id="fruits-veg" class="select select-bordered w-full">
    ...
    <div class="card bg-base-100 border border-base-content/10 shadow-sm">
        <div class="card-body gap-4">
            ...
            <div class="form-control">
                ...
                <select name="exerciseFreq" id="exercise-freq" class="select select-bordered w-full">
                    <option value="">Select frequency</option>
                        ...
                        @foreach ($phqQuestions as $question)
                            <tr>
                                ...
                                <th class="text-center">
                                    <input type="radio" name="{{ $question['name'] }}" value="Not at all" class="radio radio-sm" />
                                </th>
                                <th class="text-center">
                                    <input type="radio" name="{{ $question['name'] }}" value="Several days" class="radio radio-sm" />
                                </th>
                                <th class="text-center">
                                    <input type="radio" name="{{ $question['name'] }}" value="More than half the days" class="radio radio-sm" />
                                </th>
                                <th class="text-center">
                                    <input type="radio" name="{{ $question['name'] }}" value="Nearly every day" class="radio radio-sm" />
                                </th>
                            </tr>
                        @endforeach
                    </tbody>
                ...
                @foreach ($substances as $substance)
                    <div class="rounded-box border border-base-content/10 bg-base-200/40 p-4">
                        <label class="label cursor-pointer justify-start gap-3 px-0 pt-0">
                            <input type="checkbox" name="{{ $substance['id'] }}" data-expands="{{ $substance['id'] }}-expand" class="checkbox checkbox-sm" />
                        ...
                        <div class="expand-target hidden mt-4 space-y-4 pl-8" id="{{ $substance['id'] }}-expand">
                            <div class="form-control">
                                ...
                                <input type="text" name="{{ $substance['amountId'] }}" id="{{ $substance['amountId'] }}" placeholder="{{ $substance['amountPlaceholder'] }}" class="input input-bordered w-full" />
                            </div>
                            ...
                            <div class="form-control">
                                ...
                                <input type="range" name="{{ $substance['concernId'] }}" class="range range-sm w-full concern-slider" id="{{ $substance['concernId'] }}" min="0" max="5" step="1" value="0" />
                                <div class="mt-2 flex items-center justify-between text-sm text-base-content/70">
                                    <span>0</span>
                                    <span class="slider-value concern-display text-base-content font-bold" data-for="{{ $substance['concernId'] }}">0</span>
                                    <span>5</span>
                                </div>
                            </div>
                        </div>
    ...
    <div class="card border border-base-content/10 shadow-sm bg-green-50">
        <div class="card-body gap-4">
            ...
            <div class="form-control">
                ...
                <textarea name="lifestyleMotivation" id="lifestyle-motivation" rows="3" placeholder="1. Sleep better&#10;2. Exercise more&#10;3. Reduce stress" class="textarea textarea-bordered w-full"></textarea>
            </div>
            <div class="form-control">
                <label class="label" for="motivation-level">
                    <span class="label-text">How motivated are you to be healthier?</span>
                </label>
                <select name="motivationLevel" id="motivation-level" class="select select-bordered w-full">
