...
<body data-page="{{ $page }}">
  ...
  <script>
    window.PSYCH_ROUTES = {
      ...
      profileAccount: @json(route('psychiatrist.profile.account')),
      profileSecurity: @json(route('psychiatrist.profile.security')),
      profileNotifications: @json(route('psychiatrist.profile.notifications')),
      profileAvatar: @json(route('psychiatrist.profile.avatar')),
      profileActivity: @json(route('psychiatrist.profile.activity')),
      ...
      clinicalImages: @json(route('psychiatrist.notes.images.store', ['id' => '__ID__'])),
      ...
      templatesFavorite: @json(url('/psychiatrist/clinical-templates/__ID__/favorite')),
      templatesUsed: @json(url('/psychiatrist/clinical-templates/__ID__/used')),
