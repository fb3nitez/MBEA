...
<head>
  ...
  <title>MB.EA — Coaching Notes</title>
...
<body>
  <div class="app-shell">
    ...
    @include('lifecoach.partials.lifecoach_sidebar', ['activePage' => 'notes'])
  ...
  <script src="{{ asset('js/lifecoach/lifecoach_notes.js?v=3.0') }}"></script>
